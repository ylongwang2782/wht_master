...
#define SYS_CFG_RXAUTR                                                                                                 \
    0x20000000UL /* Receiver Auto-Re-enable. This bit is used to cause the receiver to re-enable automatically */
...
#define TX_FCTRL_PE_SHFT                                                                                               \
    (20) /* shift to access Preamble length Extension to allow specification of non-standard values */
...
#define SYS_CTRL_MASK_32                                                                                               \
    0x010003CFUL /* System Control Register access mask (all unused fields should always be writen as zero) */
/*offset 0 */
...
#define SYS_CTRL_RXDLYE                                                                                                \
    0x00000200UL /* Receiver Delayed Enable (Enables Receiver when SY_TIME[0x??] == RXD_TIME[0x??] CHECK comment*/
/*offset 16 */
/*offset 24 */
#define SYS_CTRL_HSRBTOGGLE                                                                                            \
    0x01000000UL /* Host side receiver buffer pointer toggle - toggles 0/1 host side data set pointer */
...
#define SYS_MASK_MASK_32                                                                                               \
    0x3FF7FFFEUL /* System Event Mask Register access mask (all unused fields should always be writen as zero) */
/*offset 0 */
...
#define SYS_STATUS_MASK_32                                                                                             \
    0xFFF7FFFFUL /* System event Status Register access mask (all unused fields should always be writen as zero) */
/*offset 0 */
...
#define SYS_STATUS_TXFRS                                                                                               \
    0x00000080UL /* Transmit Frame Sent: This is set when the transmitter has completed the sending of a frame */
/*offset 8 */
...
#define SYS_STATUS_ALL_RX_GOOD                                                                                         \
    (SYS_STATUS_RXDFR | SYS_STATUS_RXFCG | SYS_STATUS_RXPRD | SYS_STATUS_RXSFDD | SYS_STATUS_RXPHD | SYS_STATUS_LDEDONE)
...
#define SYS_STATUS_ALL_RX_ERR                                                                                          \
    (SYS_STATUS_RXPHE | SYS_STATUS_RXFCE | SYS_STATUS_RXRFSL | SYS_STATUS_RXSFDTO | SYS_STATUS_AFFREJ |                \
     SYS_STATUS_LDEERR)
...
#define RX_FINFO_MASK_32                                                                                               \
    0xFFFFFBFFUL /* System event Status Register access mask (all unused fields should always be writen as zero) */
...
#define RX_FINFO_RXPSR_MASK                                                                                            \
    0x000C0000UL /* RX Preamble Repetition. 00 = 16 symbols, 01 = 64 symbols, 10 = 1024 symbols, 11 = 4096 symbols */
...
#define RX_FINFO_RNG                                                                                                   \
    0x00008000UL /* Receiver Ranging. Ranging bit in the received PHY header identifying the frame as a ranging        \
                    packet. */
...
#define RX_EQUAL_FP_AMPL3_MASK                                                                                         \
    0x0000FFFF00000000ULL /* First Path Amplitude point 3 - magnitude of 1st point after Ceiling(FP_Index)  */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *RX_TTCKI The value here is the interval
                                                                                *over which the timing offset reported
                                                                                *      in the RXTOFS field of Register
                                                                                *file: 0x14 – RX_TTCKO is measured. The
                                                                                *clock offset is calculated by dividing
                                                                                *RXTTCKI by RXTOFS. The value in RXTTCKI
                                                                                *will take just one of two values
                                                                                *depending on the PRF: 0x01F00000 @ 16
                                                                                *MHz PRF, and 0x01FC0000 @ 64 MHz PRF.
                                                                                **/
...
#define RX_TTCKO_MASK_32                                                                                               \
    0xFF07FFFFUL /* Receiver Time Tracking Offset access mask (all unused fields should always be writen as zero) */
/*offset 0 */
...
#define RX_TTCKO_RCPHASE_MASK                                                                                          \
    0x7F0000000000ULL /* This 7-bit field reports the receive carrier phase adjustment at time the ranging timestamp   \
                         is made. */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *SYS_STATES Register map register file
                                                                                *0x19 is reserved
                                                                                *
                                                                                **/
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *RX_SNIFF Sniff Mode Configuration or
...
#define RX_SNIFF_SNIFF_OFFT_MASK                                                                                       \
    0x0000FF00UL /* SNIFF Mode OFF time specified in units of approximately 1mkS, or 128 system clock cycles.*/
...
#define TX_POWER_BOOSTP500_MASK                                                                                        \
    0x00000000UL /* This value sets the power applied during transmission at the 6.8 Mbps data rate frames that are    \
                    less than 0.5 ms duration */
#define BOOSTP500_MASK TX_POWER_BOOSTP500_MASK
#define TX_POWER_BOOSTP500_SHIFT (8)
#define TX_POWER_BOOSTP250_MASK                                                                                        \
    0x00000000UL /* This value sets the power applied during transmission at the 6.8 Mbps data rate frames that are    \
                    less than 0.25 ms duration */
...
#define TX_POWER_TXPOWPHR_MASK                                                                                         \
    0x0000FF00UL /* This power setting is applied during the transmission of the PHY header (PHR) portion of the       \
                    frame. */
#define TX_POWER_TXPOWSD_MASK                                                                                          \
    0x00FF0000UL /* This power setting is applied during the transmission of the synchronisation header (SHR) and data \
...
#define CHAN_CTRL_RXFPRF_MASK                                                                                          \
    0x000C0000UL /* Bits 18..19      Specify (Force) RX Pulse Repetition Rate: 00 = 4 MHz, 01 = 16 MHz, 10 = 64MHz. */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *USR_SFD Please read User Manual : User
                                                                                *defined SFD sequence
                                                                                **/
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *AGC_CTRL Please take care to write to
                                                                                *this register as doing so may cause the
...
#define EC_CTRL_MASK                                                                                                   \
    0x00000FFBUL /* sub-register 0x00 is the External clock synchronisation counter configuration register */
...
#define EC_CTRL_WAIT_MASK                                                                                              \
    0x000007F8UL /* Wait counter used for external transmit synchronisation and external timebase reset */
/* offset from EXT_SYNC_ID in bytes */
...
#define EC_GOLP_MASK                                                                                                   \
    0x0000003FUL /* sub-register 0x08 is the External clock offset to first path 1 GHz counter, EC_GOLP */
#define EC_GOLP_OFFSET_EXT_MASK                                                                                        \
    0x0000003FUL /* This register contains the 1 GHz count from the arrival of the RMARKER and the next edge of the    \
                    external clock. */
...
#define GDP0                                                                                                           \
    GxP0 /* Direction Selection for GPIO0. 1 = input, 0 = output. Only changed if the GDM0 mask bit has a value of 1   \
...
#define GIMOD0                                                                                                         \
    GIRQx0 /* GPIO IRQ Mode selection for GPIO0 input. Value 0 = Level sensitive interrupt. Value 1 = Edge triggered   \
              interrupt */
...
#define GIBES0                                                                                                         \
    GIRQx0 /* GPIO IRQ “Both Edge” selection for GPIO0 input. Value 0 = GPIO_IMODE register selects the edge. Value 1  \
              = Both edges trigger the interrupt. */
...
#define GICLR0                                                                                                         \
    GIRQx0 /* GPIO IRQ latch clear for GPIO0 input. Write 1 to clear the GPIO0 interrupt latch. Writing 0 has no       \
              effect. Reading returns zero */
...
#define GIDBE0                                                                                                         \
    GIRQx0 /* GPIO IRQ de-bounce enable for GPIO0. Value 1 = de-bounce enabled. Value 0 = de-bounce disabled */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *DRX_CONF Digital Receiver configuration
                                                                                *block
                                                                                **/
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *RF_CONF Analog RF Configuration block
                                                                                * Refer to section 7.2.41 Register file:
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *TX_CAL Refer to section 7.2.43 Register
                                                                                *file: 0x2A – Transmitter Calibration
                                                                                *block
                                                                                **/
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                * Refer to section 7.2.44 Register file:
                                                                                *0x2B – Frequency synthesiser control
                                                                                *block
                                                                                **/
...
#define FS_RES1_OFFSET                                                                                                 \
    0x00 /* reserved area. Please take care not to write to this area as doing so may cause the DW1000 to malfunction. \
          */
...
#define FS_RES2_OFFSET                                                                                                 \
    0x0C /* reserved area. Please take care not to write to this area as doing so may cause the DW1000 to malfunction. \
          */
...
#define FS_XTALT_MASK                                                                                                  \
    0x1F /* Crystal Trim. Crystals may be trimmed using this register setting to tune out errors, see 8.1 – IC         \
            Calibration – Crystal Oscillator Trim. */
#define FS_XTALT_MIDRANGE 0x10
/* offset from FS_CTRL_ID in bytes */
#define FS_RES3_OFFSET                                                                                                 \
    0x0F /* reserved area. Please take care not to write to this area as doing so may cause the DW1000 to malfunction. \
          */
...
#define AON_WCFG_OFFSET                                                                                                \
    0x00 /* used to control what the DW1000 IC does as it wakes up from low-power SLEEP or DEEPSLEEPstates. */
...
#define AON_WCFG_ONW_LEUI                                                                                              \
    0x0008 /* On Wake-up load the EUI from OTP memory into Register file: 0x01 – Extended Unique Identifier. */
#define AON_WCFG_ONW_LDC                                                                                               \
    0x0040 /* On Wake-up load configurations from the AON memory into the host interface register set */
#define AON_WCFG_ONW_L64P 0x0080 /* On Wake-up load the Length64 receiver operating parameter set */
#define AON_WCFG_PRES_SLEEP                                                                                            \
    0x0100 /* Preserve Sleep. This bit determines what the DW1000 does with respect to the ARXSLP and ATXSLP sleep     \
              controls */
...
#define AON_CTRL_OFFSET                                                                                                \
    0x02 /* The bits in this register in general cause direct activity within the AON block with respect to the stored \
            AON memory */
#define AON_CTRL_LEN (1)
#define AON_CTRL_MASK 0x8F /* access mask to AON_CTRL register */
#define AON_CTRL_RESTORE                                                                                               \
    0x01 /* When this bit is set the DW1000 will copy the user configurations from the AON memory to the host          \
            interface register set. */
#define AON_CTRL_SAVE                                                                                                  \
    0x02 /* When this bit is set the DW1000 will copy the user configurations from the host interface register set     \
            into the AON memory */
...
#define AON_CFG0_LPCLKDIVA_MASK                                                                                        \
    0x0000FFE0UL /* divider count for dividing the raw DW1000 XTAL oscillator frequency to set an LP clock frequency   \
                  */
...
#define AON_CFG1_SMXX                                                                                                  \
    0x0002 /* This bit needs to be set to 0 for correct operation in the SLEEP state within the DW1000 */
#define AON_CFG1_LPOSC_CAL                                                                                             \
    0x0004 /* This bit enables the calibration function that measures the period of the IC’s internal low powered      \
              oscillator */

/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *OTP_IF Refer to section 7.2.46 Register
                                                                                *file: 0x2D – OTP Memory Interface
                                                                                **/
...
#define OTP_ADDR_MASK                                                                                                  \
    0x07FF /* This 11-bit field specifies the address within OTP memory that will be accessed read or written. */
/* offset from OTP_IF_ID in bytes */
...
#define OTP_CTRL_OTPREAD                                                                                               \
    0x0002 /* This bit commands a read operation from the address specified in the OTP_ADDR register */
...
/* offset from OTP_IF_ID in bytes */
#define OTP_SRDAT                                                                                                      \
    0x0E /* 32-bit register. The data value stored in the OTP SR (0x400) location will appear here after power up */
#define OTP_SRDAT_LEN (4)
/* offset from OTP_IF_ID in bytes */
#define OTP_SF                                                                                                         \
    0x12 /*8-bit special function register used to select and load special receiver operational parameter              \
          */
#define OTP_SF_LEN (1)
#define OTP_SF_MASK 0x63
#define OTP_SF_OPS_KICK                                                                                                \
    0x01 /* This bit when set initiates a load of the operating parameter set selected by the OPS_SEL */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *LDE_IF Refer to section 7.2.47 Register
                                                                                *file: 0x2E – Leading Edge Detection
                                                                                *Interface PLEASE NOTE: Other areas
                                                                                *within the address space of Register
                                                                                *file: 0x2E – Leading Edge Detection
                                                                                *Interface are reserved. To ensure
                                                                                *proper operation of the LDE algorithm
                                                                                *(i.e. to avoid loss of performance or a
                                                                                *malfunction), care must be taken not to
                                                                                *write to any byte locations other than
                                                                                *those defined in the sub-sections
                                                                                *below.
                                                                                **/
...
#define LDE_PPINDX_OFFSET                                                                                              \
    0x1000 /* reporting the position within the accumulator that the LDE algorithm has determined to contain the       \
              maximum */
...
/****************************************************************************/ /**
                                                                                ...
                                                                                * It contains a number of sub-registers
                                                                                *that give diagnostics information.
                                                                                **/
...
#define EVC_CTRL_MASK                                                                                                  \
    0x00000003UL /* access mask to Register for bits should always be set to zero to avoid any malfunction of the      \
                    device. */
...
#define EVC_FCG_OFFSET                                                                                                 \
    0x08 /* The EVC_FCG field is a 12-bit counter of the frames received with good CRC/FCS sequence. */
#define EVC_FCG_LEN (2)
#define EVC_FCG_MASK 0x0FFF
/* offset from DIG_DIAG_ID in bytes */
#define EVC_FCE_OFFSET                                                                                                 \
    0x0A /* The EVC_FCE field is a 12-bit counter of the frames received with bad CRC/FCS sequence. */
#define EVC_FCE_LEN (2)
#define EVC_FCE_MASK 0x0FFF

/* offset from DIG_DIAG_ID in bytes */
#define EVC_FFR_OFFSET                                                                                                 \
    0x0C /* The EVC_FFR field is a 12-bit counter of the frames rejected by the receive frame filtering function. */
...
#define EVC_TXFS_OFFSET                                                                                                \
    0x16 /* The EVC_TXFS field is a 12-bit counter of transmit frames sent. This is incremented every time a frame is  \
            sent */
...
#define EVC_RES1_OFFSET                                                                                                \
    0x1C /* Please take care not to write to this register as doing so may cause the DW1000 to malfunction. */
...
#define DIAG_TMC_TX_PSTM                                                                                               \
    0x0010 /* This test mode is provided to help support regulatory approvals spectral testing. When the TX_PSTM bit   \
              is set it enables a repeating transmission of the data from the TX_BUFFER */

/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *0x30-0x35 Please take care not to write
                                                                                *to these registers as doing so may
...
#define PMSC_CTRL0_SYSCLKS_AUTO                                                                                        \
    0x00000000UL /* The system clock will run off the 19.2 MHz XTI clock until the PLL is calibrated and locked, then  \
                    it will switch over the 125 MHz PLL clock */
...
#define PMSC_CTRL1_ATXSLP                                                                                              \
    0x00000800UL /* If this bit is set then the DW1000 will automatically transition into SLEEP or DEEPSLEEP mode      \
                    after transmission of a frame */
#define PMSC_CTRL1_ARXSLP                                                                                              \
    0x00001000UL /* this bit is set then the DW1000 will automatically transition into SLEEP mode after a receive      \
                    attempt */
...
#define PMSC_CTRL1_PKTSEQ_DISABLE                                                                                      \
    0x00 /* writing this to PMSC CONTROL 1 register (bits 10-3) disables PMSC control of analog RF subsystems */
#define PMSC_CTRL1_PKTSEQ_ENABLE                                                                                       \
    0xE7 /* writing this to PMSC CONTROL 1 register (bits 10-3) enables PMSC control of analog RF subsystems */
/* offset from PMSC_ID in bytes */
...
#define PMSC_LEDC_BLINK_TIM_MASK                                                                                       \
    0x000000FFUL /* This field determines how long the LEDs remain lit after an event that causes them to be set on.   \
                  */
...
/****************************************************************************/ /**
                                                                                * @brief Bit definitions for register
                                                                                *0x37-0x3F Please take care not to write
                                                                                *to these registers as doing so may
                                                                                *cause the DW1000 to malfunction.
                                                                                **/
