...
#define DW_SCK_Pin GPIO_PIN_2
#define DW_SCK_GPIO_Port GPIOE
#define DW_MISO_Pin GPIO_PIN_5
#define DW_MISO_GPIO_Port GPIOE
#define DW_MOSI_Pin GPIO_PIN_6
#define DW_MOSI_GPIO_Port GPIOE
